...
zip -qr mark2_4500_v${VERSION}-mod.zip ./ -i "bin/*" -i "dtbo/*.dtbo" -i "META-INF/*" -i "system/*" -i "customize.sh" -i "module.prop" -i "uninstall.sh" -i "service.sh"
